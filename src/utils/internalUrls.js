...
export const allUrlsArr = [
  ...
  { name: 'Other Page', path: '/a' },
  { name: 'Visão Geral', path: generalVUrl },
  { name: 'Lojas', path: storesUrl },
  { name: 'Vendas', path: salesUrl },
  { name: 'Clientes', path: clientsUrl },
  { name: 'Produtos', path: productsUrl },
  { name: 'Planos e Metas', path: planNAchvmntsUrl },
  { name: 'Configurações', path: configsUrl }
];